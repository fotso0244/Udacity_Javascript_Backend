...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.mostPopularProducts = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not find most popular products. Error: ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductStore.prototype.productsByCategory = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not find products for category ".concat(category, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO products (name_prod, price, category) VALUES($1, $2, $3) RETURNING *';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not add new product named ".concat(p.name_prod, " Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
